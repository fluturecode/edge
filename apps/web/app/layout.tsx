...
export const metadata: Metadata = {
  title: 'Edge — Built on Sui',
  description: 'Programmable trust infrastructure for autonomous onchain systems',
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body style={{ margin: 0, background: '#080C14', color: '#FFFFFF', fontFamily: 'Inter, system-ui, sans-serif' }}>
        <style>{`
        ...
        `}</style>
        <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: 'clamp(12px, 2vw, 14px) clamp(16px, 4vw, 24px)', borderBottom: '1px solid #1A2740', background: '#080C14', position: 'sticky', top: 0, zIndex: 50 }}>
          ...
          <div style={{ background: '#0D1420', border: '1px solid #1A2740', borderRadius: 8, padding: '5px 12px', display: 'flex', alignItems: 'center', gap: 6 }}>
